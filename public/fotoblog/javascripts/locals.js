	...
	$(document).keyup(function(a) { 
        switch (a.keyCode) {
            case 37:
            	...
            	location = '/fotoblog/id/'+prev_image;
                break;
            case 39:
                if (active_tab!='') {
                    return false;
                }
                location = '/fotoblog/id/'+next_image;
                break;
            case 27:
                tab_min();
                break;
	...
	function next() {
        ...
        //console.log(active);
		if (active) {
			window.location = '/fotoblog/id/'+next_image;
		}
	}
        ...
        if (active_tab!='minimize') {
            if (active_tab=='') {
                ...
                $('#content').animate({
                    ...
                    $('#contentframe').hide();
                    $('#content').prepend($('<a id="logo_min" style="display:none" target="_top" href=""><img src="/fotoblog/images/logo_sib_portal.png" alt="SIB Colombia"></a>'));
                    $('#logo_min').fadeIn();
                    });
            } else {
